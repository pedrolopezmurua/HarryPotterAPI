    ...
    <div className="container text-center">
      <div className="p-5 row ">
        <div className="col col-lg-6 text-center">
          <h1
            className="text-dark col p-5"
            style={{ fontSize: '50px', fontFamily: 'sans-serif', color: 'gray' }}
          >
            Grandes aventuras junto a Harry Potter
          </h1>
          <p style={{ fontSize: '20px' }}>
            {' '}
            "¡Bienvenido a un mundo de magia, hechicería y aventura! Prepárate para seguir a Harry Potter en su
      ...
      <div className="container">
        ...
        <h2 style={{ fontSize: '36px', marginBottom: '50px' }}>Personajes de Harry Potter</h2>
        <ListarPersonajes showAll={false} />

        <h2 style={{ fontSize: '36px',  marginTop: '50px', marginBottom: '50px' }}>Hechizos de Harry Potter</h2>
        <ListarHechizos showAll={false} />
